...
AW_Menu_AO = [
	...
	["Turn active AO Blue", [8], "", -5, [["expression", "AW_redTotalScore = 99999;publicVariableServer 'AW_redTotalScore'"]], "1", "1"],
...
AW_Menu_ManipAOs = [
	...
	["Dump Arrays to RPT",[6],"",-5,[["expression","[]execVM 'aw5_score\dev\dumpArrays.sqf'"]],"1","1"],
	["Cancel current action",[7],"",-5,[["expression","onMapSingleClick ''"]],"1","1"],
	["Recreate Markers",[8],"",-5,[["expression","AW_EH_recreateCornersAndAOs = 1;publicVariableServer 'AW_EH_recreateCornersAndAOs';"]],"1","1"],
...
AW_Menu_Officers = [
	["Settings",false],
	["Satellite",[2],"",-5,[["expression","execVM 'C2C\imagery\satview.sqf';"]],"1","1"],
	["Artillery",[3],"",-5,[["expression","execVM 'artillery\UI\openArtyUI.sqf';"]],"1","1"],
	["Select next AO", [8], "", -5, [["expression", "[]execVM 'aw5_score\client\chooseNewAO.sqf';"]], "1", "1"]
	];
	
BIS_MENU_GroupCommunication = [
	["Tools", false],
	//["TM Tools",[2],"#USER:AW_Menu_TM",-5,[["expression",""]],"1","1"],
	["Marker Options",[2],"#USER:AW_Menu_Markers",-5,[["expression",""]],"1","1"],
	["Unflip vehicle",[3],"",-5,[["expression","execVM 'core\fixes\unflipVehicle.sqf';"]],"1","1"],
	//["Move AO",[5],"#USER:AW_MoveAOMenu_1",-5,[["expression",""]],"1","1"],
	["Mission Settings",[4],"#USER:AW_Menu_Settings",-5,[["expression",""]],"1","1"],
	["Officer Tools",[7],"#USER:AW_Menu_Officers",-5,[["expression",""]],"1","1"]
