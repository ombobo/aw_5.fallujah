...
class AW_RscGUIListBox : AW_RscListBox {
	color[] = {1, 1, 1, 1};
...
class AW_RscComboBox : AW_RscText {
		type = CT_COMBO;
		style = ST_LEFT;
		rowHeight = 0.028;
...
class AW_RscGUIShortcutButton : AW_RscShortcutButton {
	w = 0.183825;
	h = 0.0522876;
	style = 2;
	color[] = {1, 1, 1, 1};
...
class AW_RscMap {
	...
	w = 1; 
	h = 1;	
	colorBackground[] = {1.00, 1.00, 1.00, 1};
